...
#ifndef APDBifurcation_varypcl_h
#define APDBifurcation_varypcl_h
...
public:
    ...
    PRECTYPE casrs[2*ncells*beats];
#endif
    PRECTYPE pcls1[ncells];
    PRECTYPE pcls2[ncells];
...
#endif //APDBifurcation_varypcl_h
