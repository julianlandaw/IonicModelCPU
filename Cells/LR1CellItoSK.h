...
//
#ifndef LR1CellItoSK_h
#define LR1CellItoSK_h
...
public:
    ...
    void setcell (int id, LR1CellItoSK<1>* newcell);
    
    void getcell (int id, LR1CellItoSK<1>* newcell);
    
    void saveconditions(FILE* file, int id, bool header, double t=0.0);
};

#endif // LR1CellItoSK_h
