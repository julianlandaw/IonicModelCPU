...
//
#ifndef LR1CellIto_nsca_h
#define LR1CellIto_nsca_h

template <int ncells>
class LR1CellIto_nsca
{
public:
    ...
    double inscafac[ncells]; // non-selective calcium current factor
    ...
    void comp_ical (int id, double dt, double& dd, double& df, double& ical, double& icalna, double& icalk); // L-type Calcium Current
